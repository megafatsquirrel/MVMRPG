...
RPG.PlayerMenuItem = function (game_state, name, position, properties) {
    ...
    this.player_unit_health = new RPG.ShowStat(this.game_state, this.text + "_health", {x: 202, y: this.y + 20}, {group: "hud", text: "", style: properties.style, prefab: this.text, stat: "health"});
    this.player_unit_mana = new RPG.ShowStat(this.game_state, this.text + "_health", {x: 202, y: this.y + 40}, {group: "hud", text: "", style: properties.style, prefab: this.text, stat: "mana"});
};
